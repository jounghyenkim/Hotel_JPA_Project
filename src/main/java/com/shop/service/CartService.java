...
public class CartService {
    ...
    public Long addCart(ItemSearchDto itemSearchDto, String email, Long itemId){
        ...
        if(savedCartItem != null){
            savedCartItem.addCount(itemSearchDto.getSearchCount());
            return savedCartItem.getId();
        }
        else{
            CartItem cartItem = CartItem.createCartItem(cart, item, itemSearchDto,member);
